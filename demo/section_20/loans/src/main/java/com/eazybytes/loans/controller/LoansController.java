...
@RestController
@RequestMapping(path = LoansConstants.LOANS_BASE, produces = {MediaType.APPLICATION_JSON_VALUE})
@Validated
public class LoansController {
    ...
    @PostMapping(LoansConstants.CREATE_URL)
    ...
    @GetMapping(LoansConstants.FETCH_URL)
    ...
    @PutMapping(LoansConstants.UPDATE_URL)
    ...
    @DeleteMapping(LoansConstants.DELETE_URL)
