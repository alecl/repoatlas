...
@RestController
@RequestMapping(path = CardsConstants.CARDS_BASE, produces = {MediaType.APPLICATION_JSON_VALUE})
@Validated
public class CardsController {
    ...
    @PostMapping(CardsConstants.CREATE_URL)
    ...
    @GetMapping(CardsConstants.FETCH_URL)
    ...
    @PutMapping(CardsConstants.UPDATE_URL)
    ...
    @DeleteMapping(CardsConstants.DELETE_URL)
